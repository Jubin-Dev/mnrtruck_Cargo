        ...
        home:Scaffold(
          ...
          elevation: 10.0,
                  ...
                  onPressed: (){ showDialog(
                                  ...
                                  builder: (context) => new ConstrainedBox( constraints: BoxConstraints(maxHeight: 150.0),
                                    child:
                                  AlertDialog(
                    ...
                    Widget _dispItems(BuildContext context, int countVal)
                    {
                      ...
                      return new Container(
                        ...
                        // horizontal, this would produce 2 rows.
                          ...
                          children:<Widget> [
                            cardDisp(context,'Pre Gate-In','lib/img/cargo-container.png'),
                            cardDisp(context,'Survey','lib/img/hypad-container.png'),
                            cardDisp(context,'Container Status','lib/img/553675_orig.png'),
                            cardDisp(context,'Reach Stacker','lib/img/Container-and-Intermodal.png'),
                          ]
                        )
                      );
                    }
